...
numerical_embedding_df = numerical_embedding_df.select("INDEX","TIER_2_NUMERICAL_EMBEDDINGS","TIER_4_NUMERICAL_EMBEDDINGS")
...
full_df = full_df.withColumn('FULL_EMBEDDING', concat(col('TIER_1_TEXT_EMBEDDINGS'), col('TIER_2_NUMERICAL_EMBEDDINGS')))
...
lookup_items = ['2e0916441288b9764ac3923ec6c4a7a161f34bfbe82f2a864d554ae2a222c87b','a16683f286c63b9b14fd840ded1dce8e1db3df55ed893e150ba38b0ea1111897','baf19cb1f844398751bbaf4858ae09d06a402806195ace14c00c47047a1c1c69']
