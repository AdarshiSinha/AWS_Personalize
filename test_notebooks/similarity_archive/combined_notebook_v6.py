...
configs_df.where( (configs_df.PRODUCT_KEY =='PRD-U8U4UG9AS') ).display()
configs_df.count()
...
num_dense_layer = Dense(2, activation='relu')(num_concatenated_inputs)
num_output_layer = Dense(2, activation='linear')(num_dense_layer)
