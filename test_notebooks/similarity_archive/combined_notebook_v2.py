...
full_df = full_df.withColumn('FULL_EMBEDDING', concat(col('TIER_1_TEXT_EMBEDDINGS'), col('TIER_2_TEXT_EMBEDDINGS'), col('TIER_2_NUMERICAL_EMBEDDINGS')))
...
lookup_items = ['2e0916441288b9764ac3923ec6c4a7a161f34bfbe82f2a864d554ae2a222c87b']
